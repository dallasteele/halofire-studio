...
def _portal_bundle_section(violations: list[dict[str, Any]]) -> str:
    ...
    return (
        ...
        '<a class="download-link" href="./evidence_upload_status.json" target="_blank" rel="noopener"><span class="download-label">Evidence upload status</span><span class="download-path">evidence_upload_status.json</span></a>'
        ...
        '</div>'
        '<div style="padding:12px 13px;border-radius:12px;border:1px solid rgba(126,211,255,0.16);background:rgba(126,211,255,0.05)">'
        '<div style="font-size:10px;letter-spacing:0.18em;text-transform:uppercase;color:#7ed3ff;margin-bottom:6px">Evidence upload status</div>'
        '<div style="font-size:13px;line-height:1.5;color:#f5f5f7">Surface staged uploads, rejected uploads, and lane readiness as a first-class artifact in the shared bid bundle.</div>'
        '</div>'
        '</div>'
