...
import * as checkSpacingModule from './checkSpacing.mjs'
import { checkSpacing } from './checkSpacing.mjs'

test('exports only checkSpacing from the ESM module', () => {
  assert.deepEqual(Object.keys(checkSpacingModule), ['checkSpacing'])
  assert.equal(typeof checkSpacingModule.checkSpacing, 'function')
  assert.equal('default' in checkSpacingModule, false)
})
