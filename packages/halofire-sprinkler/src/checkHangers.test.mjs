...
import * as checkHangersModule from './checkHangers.mjs'
import { checkHangerSpacing } from './checkHangers.mjs'

test('exports only checkHangerSpacing from the ESM module', () => {
  assert.deepEqual(Object.keys(checkHangersModule), ['checkHangerSpacing'])
  assert.equal(typeof checkHangersModule.checkHangerSpacing, 'function')
  assert.equal('default' in checkHangersModule, false)
})
