...
test('frictionLossForRun rejects invalid segment input', () => {
  assert.throws(() => frictionLossForRun([{ Q: 80, d: 0, len: 12 }]), /Invalid diameter/);
  assert.throws(() => frictionLossForRun('nope'), /segments must be an array/);
});
