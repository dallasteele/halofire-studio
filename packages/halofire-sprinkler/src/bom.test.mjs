...
import * as bomModule from './bom.mjs'
import { bomFromCounts } from './bom.mjs'

test('exports only bomFromCounts from the ESM module', () => {
  assert.deepEqual(Object.keys(bomModule), ['bomFromCounts'])
  assert.equal(typeof bomModule.bomFromCounts, 'function')
  assert.equal('default' in bomModule, false)
})
