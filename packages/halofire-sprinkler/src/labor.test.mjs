...
import * as laborModule from './labor.mjs'
import { laborHours } from './labor.mjs'

test('exports only laborHours from the ESM module', () => {
  assert.deepEqual(Object.keys(laborModule), ['laborHours'])
  assert.equal(typeof laborModule.laborHours, 'function')
  assert.equal('default' in laborModule, false)
})
