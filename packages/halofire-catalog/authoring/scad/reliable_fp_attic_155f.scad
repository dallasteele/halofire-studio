...
// Source: data/phase_d_manifest.json (sku_intent='reliable-fp-attic-155f').
// Do not hand-edit — regenerate from the manifest.
//
// @part reliable_fp_attic_155f
// @kind sprinkler_head
// @category head.upright.k56
// @display-name "Reliable Model FP Attic Sprinkler K5.6 155°F"
