...
// Source: data/phase_d_manifest.json (sku_intent='reliable-f1res58-pendent-175f').
// Do not hand-edit — regenerate from the manifest.
//
// @part reliable_f1res58_pendent_175f
// @kind sprinkler_head
// @category head.pendant.k58
// @display-name "Reliable F1Res 58 Residential Pendent K5.8 175°F"
