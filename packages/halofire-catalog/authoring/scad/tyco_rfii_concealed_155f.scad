...
// Source: data/phase_d_manifest.json (sku_intent='tyco-rfii-concealed-155f').
// Do not hand-edit — regenerate from the manifest.
//
// @part tyco_rfii_concealed_155f
// @kind sprinkler_head
// @category head.pendant.k49
// @display-name "Tyco RFII Concealed Residential K4.9 155°F"
