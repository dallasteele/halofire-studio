...
// Source: data/phase_d_manifest.json (sku_intent='reliable-f1fr56-qr-pendent-175f').
// Do not hand-edit — regenerate from the manifest.
//
// @part reliable_f1fr56_qr_pendent_175f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Reliable F1FR56 QR Pendent K5.6 175°F"
