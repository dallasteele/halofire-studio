...
// Source: data/phase_d_manifest.json (sku_intent='bline-b3100-c-clamp-beam').
// Do not hand-edit — regenerate from the manifest.
//
// @part bline_b3100_c_clamp_beam
// @kind hanger
// @category hanger.beam.clamp
// @display-name "B-Line B3100 C-Clamp Beam Attachment"
// @mfg eaton_b_line
// @mfg-pn B3100
// @listing UL
// @price-usd 3.25
