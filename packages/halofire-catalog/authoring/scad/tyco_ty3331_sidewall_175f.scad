...
// Source: data/phase_d_manifest.json (sku_intent='tyco-ty3331-sidewall-175f').
// Do not hand-edit — regenerate from the manifest.
//
// @part tyco_ty3331_sidewall_175f
// @kind sprinkler_head
// @category head.sidewall.k56
// @display-name "Tyco TY3331 Horizontal Sidewall K5.6 175°F"
