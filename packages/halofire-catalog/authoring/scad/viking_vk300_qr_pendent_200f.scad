...
// Source: data/phase_d_manifest.json (sku_intent='viking-vk300-qr-pendent-200f').
// Do not hand-edit — regenerate from the manifest.
//
// @part viking_vk300_qr_pendent_200f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Viking VK300 Quick-Response Pendent K5.6 200°F"
// @mfg viking_group
// @mfg-pn VK300
// @listing UL FM
