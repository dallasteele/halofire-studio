...
// Source: data/phase_d_manifest.json (sku_intent='tolco-fig4-swivel-ring-2in').
// Do not hand-edit — regenerate from the manifest.
//
// @part tolco_fig4_swivel_ring_2in
// @kind hanger
// @category hanger.swivel.ring
// @display-name "Tolco FIG 4 Adjustable Swivel Ring Hanger 2\""
// @mfg nvent_tolco
// @mfg-pn FIG_4_2in
// @listing UL
// @price-usd 5.10
