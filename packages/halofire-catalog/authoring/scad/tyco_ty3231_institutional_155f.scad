...
// Source: data/phase_d_manifest.json (sku_intent='tyco-ty3231-institutional-155f').
// Do not hand-edit — regenerate from the manifest.
//
// @part tyco_ty3231_institutional_155f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Tyco TY3231 Institutional Pendent K5.6 155°F"
