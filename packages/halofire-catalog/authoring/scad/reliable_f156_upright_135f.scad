...
// Source: data/phase_d_manifest.json (sku_intent='reliable-f156-upright-135f').
// Do not hand-edit — regenerate from the manifest.
//
// @part reliable_f156_upright_135f
// @kind sprinkler_head
// @category head.upright.k56
// @display-name "Reliable F1-56 Upright K5.6 SR 135°F"
