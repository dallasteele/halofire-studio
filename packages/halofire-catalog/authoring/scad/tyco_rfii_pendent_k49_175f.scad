...
// Source: data/phase_d_manifest.json (sku_intent='tyco-rfii-pendent-k49-175f').
// Do not hand-edit — regenerate from the manifest.
//
// @part tyco_rfii_pendent_k49_175f
// @kind sprinkler_head
// @category head.pendant.k49
// @display-name "Tyco RFII Residential Pendent K4.9 175°F"
