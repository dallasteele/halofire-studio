...
// Source: data/phase_d_manifest.json (sku_intent='globe-gl8016-upright-200f').
// Do not hand-edit — regenerate from the manifest.
//
// @part globe_gl8016_upright_200f
// @kind sprinkler_head
// @category head.upright.k80
// @display-name "Globe GL8016 Upright K8.0 SR 200°F"
// @mfg globe_fire_sprinkler
// @mfg-pn GL8016
// @listing UL FM
