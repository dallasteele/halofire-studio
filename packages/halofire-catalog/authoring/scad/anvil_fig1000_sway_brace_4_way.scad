...
// Source: data/phase_d_manifest.json (sku_intent='anvil-fig1000-sway-brace-4-way').
// Do not hand-edit — regenerate from the manifest.
//
// @part anvil_fig1000_sway_brace_4_way
// @kind hanger
// @category brace.4.way
// @display-name "Anvil FIG 1000 Seismic Sway Brace — 4-Way"
