...
// Source: data/phase_d_manifest.json (sku_intent='viking-vk457-concealed-175f').
// Do not hand-edit — regenerate from the manifest.
//
// @part viking_vk457_concealed_175f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Viking VK457 Concealed Pendent K5.6 175°F"
// @mfg viking_group
// @mfg-pn VK457
// @listing UL FM
