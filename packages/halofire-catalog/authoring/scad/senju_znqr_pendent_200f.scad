...
// Source: data/phase_d_manifest.json (sku_intent='senju-znqr-pendent-200f').
// Do not hand-edit — regenerate from the manifest.
//
// @part senju_znqr_pendent_200f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Senju ZN-QR Quick Response Pendent K5.6 200°F"
// @mfg senju_sprinkler
// @mfg-pn ZN-QR
// @listing UL FM
