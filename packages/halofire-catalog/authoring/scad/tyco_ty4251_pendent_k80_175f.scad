...
// Source: data/phase_d_manifest.json (sku_intent='tyco-ty4251-pendent-k80-175f').
// Do not hand-edit — regenerate from the manifest.
//
// @part tyco_ty4251_pendent_k80_175f
// @kind sprinkler_head
// @category head.pendant.k80
// @display-name "Tyco TY4251 Pendent K8.0 SR 175°F"
