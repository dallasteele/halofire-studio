...
// Source: data/phase_d_manifest.json (sku_intent='viking-vk597-dry-pendent-200f').
// Do not hand-edit — regenerate from the manifest.
//
// @part viking_vk597_dry_pendent_200f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Viking VK597 Dry Pendent K5.6 200°F"
// @mfg viking_group
// @mfg-pn VK597
// @listing UL FM
