...
// Source: data/phase_d_manifest.json (sku_intent='viking-vk630-sidewall-175f').
// Do not hand-edit — regenerate from the manifest.
//
// @part viking_vk630_sidewall_175f
// @kind sprinkler_head
// @category head.sidewall.k56
// @display-name "Viking VK630 Horizontal Sidewall K5.6 QR 175°F"
// @mfg viking_group
// @mfg-pn VK630
// @listing UL FM
