...
// Source: data/phase_d_manifest.json (sku_intent='senju-znqr-pendent-155f').
// Do not hand-edit — regenerate from the manifest.
//
// @part senju_znqr_pendent_155f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Senju ZN-QR Quick Response Pendent K5.6 155°F"
// @mfg senju_sprinkler
// @mfg-pn ZN-QR
// @listing UL FM
