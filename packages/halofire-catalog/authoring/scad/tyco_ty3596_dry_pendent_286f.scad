...
// Source: data/phase_d_manifest.json (sku_intent='tyco-ty3596-dry-pendent-286f').
// Do not hand-edit — regenerate from the manifest.
//
// @part tyco_ty3596_dry_pendent_286f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Tyco TY3596 Dry Pendent K5.6 286°F"
