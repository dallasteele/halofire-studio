...
// Source: data/phase_d_manifest.json (sku_intent='reliable-f180-upright-200f').
// Do not hand-edit — regenerate from the manifest.
//
// @part reliable_f180_upright_200f
// @kind sprinkler_head
// @category head.upright.k80
// @display-name "Reliable F1-80 Upright K8.0 SR 200°F"
