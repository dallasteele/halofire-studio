...
// Source: data/phase_d_manifest.json (sku_intent='tyco-ty1234-qr-pendent-155f').
// Do not hand-edit — regenerate from the manifest.
//
// @part tyco_ty1234_qr_pendent_155f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Tyco TY1234 Quick-Response Pendent K5.6 155°F"
