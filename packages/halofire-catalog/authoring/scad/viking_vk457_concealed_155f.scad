...
// Source: data/phase_d_manifest.json (sku_intent='viking-vk457-concealed-155f').
// Do not hand-edit — regenerate from the manifest.
//
// @part viking_vk457_concealed_155f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Viking VK457 Concealed Pendent K5.6 155°F"
// @mfg viking_group
// @mfg-pn VK457
// @listing UL FM
