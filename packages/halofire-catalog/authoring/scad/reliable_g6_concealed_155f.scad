...
// Source: data/phase_d_manifest.json (sku_intent='reliable-g6-concealed-155f').
// Do not hand-edit — regenerate from the manifest.
//
// @part reliable_g6_concealed_155f
// @kind sprinkler_head
// @category head.pendant.k56
// @display-name "Reliable G6 Concealed Pendent K5.6 155°F"
