...
export function renderMitRiversideBuildingJCalibrationViews(packet) {
  ...
  const topSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 920 470"><style>rect{fill:#07111f}line{stroke:#22d3ee;stroke-width:1.5}.u{fill:#f59e0b}.p{fill:#22d3ee}text{fill:#e2e8f0;font:14px sans-serif}.warn{fill:#fbbf24}</style><rect width="920" height="470"/><g>${grid}</g>${upright}${pendent}<text x="22" y="27">Building J completed-bid registration: structural grid within 0.8 px; schedule 53 upright + 15 pendent = 68</text><text x="22" y="448" class="warn">Count glyphs only - not extracted head coordinates; approved plan page 2 remains the layout proof</text></svg>`;
