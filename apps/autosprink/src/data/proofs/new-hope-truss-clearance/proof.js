...
try {
  ...
  document.querySelector('#threaded-terminal-catalog-part-status').textContent = `PASS: New Hope quote 0133820 binds ASC/SCI Fig 3201 product ${threadedTerminalCatalogParts.parts[0].purchaseProductNumber} at A=${threadedTerminalCatalogParts.parts[0].publishedDimensionsIn.centerToEndA.toFixed(2)} in and Fig 3221R product ${threadedTerminalCatalogParts.parts[1].purchaseProductNumber} at A=${threadedTerminalCatalogParts.parts[1].publishedDimensionsIn.overallLengthA.toFixed(2)} in; thread engagement and takeout remain blocked`;
