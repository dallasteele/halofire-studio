...
try {
  ...
  document.querySelector('#purchased-support-component-status').textContent = `REJECTED FROM INSTALLED MODEL: quote 0133821 binds ${purchasedSupportComponents.metrics.purchasedSupportLineCount} support product lines / ${purchasedSupportComponents.metrics.purchasedSupportUnitCount} units. Official Victaulic AB2 Revit families are hash-bound, but extraction, dimension audit, threads, mating, placement, and exact CAD for every other support remain required`;
