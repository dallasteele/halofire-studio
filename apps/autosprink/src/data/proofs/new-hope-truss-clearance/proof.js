...
try {
  ...
  document.querySelector('#purchased-support-component-status').textContent = `REJECTED FROM INSTALLED MODEL: quote 0133821 binds ${purchasedSupportComponents.metrics.purchasedSupportLineCount} support product lines / ${purchasedSupportComponents.metrics.purchasedSupportUnitCount} units, including Anvil Fig. 69 hangers and VicFlex AB2 brackets; exact CAD, threads, and mating assemblies remain required`;
