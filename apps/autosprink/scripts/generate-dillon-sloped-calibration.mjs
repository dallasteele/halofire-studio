...
const cross = [[406.41,660.71],[555.99,660.7],[451.77,589.95],[518.85,589.95],[598.89,589.95],[406.41,871],[555.99,870.96],[406.41,1038.57],[555.99,1038.57],[652.83,926.34],[2340.51,637.66]];
...
const draft = {
  ...
  coverage: { complete: false, detectedVectorCandidates: 51, unresolved: ['FP-1 schedule declares 52 heads but the FP-1 vector sheet contains 51 symbols (40 round + 11 alternate); FP-2 is a separate 25-head upper-level schedule and cannot close this mismatch.'] },
  limitations: ['protected-sloped-heads-not-mapped-to-hydraulic-remote-area-nodes','code-compliance-and-approval-not-inferred-from-completed-bid','fp1-schedule-to-vector-count-mismatch-one-head-unresolved'],
