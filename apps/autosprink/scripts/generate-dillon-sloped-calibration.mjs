...
const rcpRegions = [
  { id: 'slope-region-east-patio', annotationId: 'slope-3', polygon: [[1940,1215],[2225,1215],[2225,1415],[1940,1415]], protectionBasis: 'completed-bid-no-submitted-heads', submittedHeadIds: [] },
  { id: 'slope-region-east-covered', annotationId: 'slope-6', polygon: [[1670,1085],[1900,1085],[1900,1330],[1670,1330]], protectionBasis: 'completed-bid-protected', submittedHeadIds: ['round-27','round-29'] },
  { id: 'slope-region-south-covered', annotationId: 'slope-7', polygon: [[1560,1425],[1805,1425],[1805,1750],[1560,1750]], protectionBasis: 'completed-bid-no-submitted-heads', submittedHeadIds: [] },
  { id: 'slope-region-west-covered', annotationId: 'slope-8', polygon: [[1285,1560],[1590,1560],[1590,1850],[1285,1850]], protectionBasis: 'completed-bid-no-submitted-heads', submittedHeadIds: [] },
];
const draft = {
  ...
  slopeRegions: rcpRegions.map((region) => ({ id: region.id, annotationId: region.annotationId, polygonRcpPt: region.polygon, polygonSubmittedPt: region.polygon.map(([x, y]) => [x + 114, y - 460]), slopeAxis: 'y', downhillDirection: 'positive-y', protectionBasis: region.protectionBasis, submittedHeadIds: region.submittedHeadIds })),
