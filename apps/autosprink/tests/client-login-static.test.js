...
describe('client secure login page', () => {
  it('uses a text-only Halo Fire wordmark in front of the animated WebGL hero', () => {
    ...
    expect(html).toContain('data-wordmark-centerline="410"');
    ...
    expect(html).toContain('width:min(132%,1120px)');
    ...
    expect(html).toContain('filter:url(#wordmarkGlassLift)');
    expect(html).toContain('opacity:0.76');
    expect(html).toContain('stop-color="rgba(2,1,1,0.58)"');
    expect(html).toContain('.hero-wordmark .wordmark-backlight');
    expect(html).toContain('fill:url(#wordmarkFlameBacklight)');
    expect(html).toContain('radialGradient id="wordmarkFlameBacklight"');
    expect(html).toContain('class="wordmark-depth"');
    expect(html).toContain('class="wordmark-rim"');
    expect(html).toContain('class="wordmark-sheen"');
    expect(html).toContain('<text class="wordmark-glass" x="392" y="118" font-size="104" text-anchor="end">Halo</text>');
    expect(html).toContain('<text class="wordmark-glass" x="438" y="118" font-size="104" text-anchor="start">Fire</text>');
    expect(html).not.toContain('.hero-wordmark .wordmark-outline');
    expect(html).not.toContain('stroke:rgba(245,197,59,0.72)');
    expect(html).not.toContain('repeating-linear-gradient(0deg,rgba(255,255,255,0.025) 0 1px,transparent 1px 12px)');
